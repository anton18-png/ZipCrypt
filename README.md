...
### Будущие методы шифрования
#### Двоичный код -> Base64 -> OpenSSL -> 7zip без шифрования пароля (скоро)
#### Двоичный код -> Base64 -> OpenSSL -> 7zip Без пароля (скоро)

## Рекомендации по выбору метода
| Метод                  | Безопасность | Скорость | Применение                          |
|------------------------|--------------|----------|-------------------------------------|
| binary_openssl_7zip    | ⭐⭐⭐⭐⭐      | ⭐⭐       | Конфиденциальные данные             |
| openssl_only           | ⭐⭐⭐⭐⭐      | ⭐⭐⭐      | Одиночные файлы без сжатия          |
| openssl_7zip           | ⭐⭐⭐⭐       | ⭐⭐⭐      | Баланс безопасности и производит.   |
| 7zip_no_encryption     | ⭐⭐          | ⭐⭐⭐⭐    | Внутреннее использование            |
| no_password            | ⭐            | ⭐⭐⭐⭐⭐   | Неконфиденциальные данные           |
